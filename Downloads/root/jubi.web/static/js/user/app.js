...
var controllers = angular.module('Jubi.controllers', ['ngAudio', 'com.2fdevs.videogular', 'ngQuill', 'ngCookies']);
...
controllers.controller('RootController', ['$scope', '$q', '$http', '$timeout', '$window', 'authService', 'helperService', '$modal', 'sessionStorageService', '$rootScope', 'controllerState','$cookies',
function ($scope, $q, $http, $timeout, $window, authService, helperService, $modal, sessionStorageService, $rootScope, controllerState, $cookies) {
        ...
        $scope.programClick = function (index, program) {
                            ...
                            if (slug && p.slug == slug) {
                                ...
                                prepForum(program).then(function (results) {
                                    ...
                                    $q.all([
                                        ...
                                        $rootScope.childUserGroups = angular.copy(results[3].data);
        ...
        $rootScope.$on('userGroupAdded', function (e, item) {
            ...
            $rootScope.childUserGroups.push(item);
        });
        ...
        $rootScope.$on('userGroupRemoved', function (e, item) {
            ...
            _.each(groups, function (group) {
                ...
                $rootScope.childUserGroups = _.without($rootScope.childUserGroups, group);
            });
        });
