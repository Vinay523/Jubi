    ...
    FSP = (function() {
      ...
      FSP.prototype.createWrappers = function() {
        this.mainWrapper = $("<div/>", {
          ...
          "style": this.options.inlineStyles ? "background: " + this.options.bgColor + ";opacity:0.9; position: fixed; top: 0; left: 0; right: 0; bottom: 0; z-index: 9999; overflow-y: auto; overflow-x: hidden; display: none" : void 0
        });
        ...
        return this.close = $("<a/>", {
          ...
          "style": this.options.inlineStyles ? "position: absolute; right: 20px; top: 10px; font-size:40px" : void 0
        }).appendTo(this.mainWrapper);
      };
